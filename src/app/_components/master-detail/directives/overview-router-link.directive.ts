...
@Directive({selector: ':not(a):not(area)[masterRouterLink]'})
export class OverviewRouterLinkDirective extends RouterLink {
  ...
  @Input()
  set masterRouterLink(myCommands: any[]|string) {
    if (myCommands != null) {
