...
## Einleitung
Umetzung des Games of Life von John Conway als Angular Applikation. 
...
1. Erster Schritt das Repository clonen:
    ```bash
    $ git clone https://github.com/.......
    $ cd game-of-life
    ```

2. Installieren der Amplify CLI:
    ```bash
    $ amplify init
    ```

3. Benötigte Module installieren:
